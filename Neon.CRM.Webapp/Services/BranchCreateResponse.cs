...
public class Endpoint
{
    ...
    public string id { get; set; }
    public string slug { get; set; }
    public string branch_slug { get; set; }
    public string project_slug { get; set; }
    public string project_id { get; set; }
...
public class Hosts
{
    public string read_write_host { get; set; }
    public string read_write_pooled_host { get; set; }
}

public class Group
{
    public Size size { get; set; }
    public bool allow_readable_secondaries { get; set; }
    public Compute[] computes { get; set; }
}
...
public class Compute
{
    ...
    public string compute_host { get; set; }
    public string compute_pooled_host { get; set; }
    public DateTime created_at { get; set; }
    public DateTime updated_at { get; set; }
}
